...
class PillarMoveTest {
    ...
    void apply_shiftsAllChunksOfTask_byPositiveN() {
        ...
        TaskChunk chunkA = chunk(taskId, 0, null, null);
        TaskChunk chunkB = chunk(taskId, 1, null, null);
        TaskChunk chunkC = chunk(taskId, 2, null, null);
    ...
    void apply_returnsNull_whenTargetSlotOccupiedByOtherTask() {
        ...
        TaskChunk chunkA = chunk(taskId,      0, null, null);
        TaskChunk other  = chunk(otherTaskId, 0, null, null);
